...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * Created by daiyingheng on 16/9/3.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      */
...
var NavbarActions = function () {
  function NavbarActions() {
    ...
    this.generateActions('updateOnlineUsers', 'updateAjaxAnimation', 'updateSearchQuery', 'findCharacterSuccess', 'findCharacterFail');
  }
...
},{"./Sidebar":12,"react":"react"}],7:[function(require,module,exports){
'use strict';
...
},{"../actions/FooterActions":1,"../stores/FooterStore":15,"react":"react","react-router":"react-router"}],9:[function(require,module,exports){
'use strict';
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    key: 'render',
    value: function render() {
      var articleNodes = this.state.articles.map(function (character, index) {
        return _react2.default.createElement(
          'div',
          { className: 'bubble' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              { className: 'summary' },
              '自定义事 在这个过程中，createEvent 方法创建了一个空事件 evt，然后使用 initEvent 方法定义事件的类型为约定好的自定义事件，再对相应的元素进行监听，接着，就是使用 dispatchEvent 触发事件了。件就是有别于如 click, submit 等标准事件的自行定制的事件，在叙述自定义事件有何好处之前，先来看一个自定义事件的例子：'
            ),
            _react2.default.createElement(
              'p',
              { className: 'detail' },
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'home_header padding-top80' },
          _react2.default.createElement(
            'div',
            { className: 'info' },
            _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'home_left col-xs-10 col-sm-10 col-md-7 col-xs-offset-1 col-sm-offset-1 col-md-offset-1' },
          articleNodes
        ),
        _react2.default.createElement(
          'div',
          { className: 'home_right col-xs-1 col-sm-1 col-md-3' },
          _react2.default.createElement(
            'div',
            { className: 'portrait' },
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement('img', { src: '/img/portrait.jpg' })
              )
            ),
            _react2.default.createElement(
              'div',
...
},{"../actions/HomeActions":2,"../stores/HomeStore":16,"react":"react","react-router":"react-router"}],10:[function(require,module,exports){
'use strict';
  ...
  _createClass(Navbar, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'nav',
          { className: 'navbar navbar-default navbar-static-top animated header--fixed' },
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'form',
              { ref: 'searchForm', className: 'navbar-form navbar-left animate clearfix', onSubmit: this.handleSubmit.bind(this) },
              _react2.default.createElement(
                'div',
                { className: 'input-group' },
                _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: '搜索', value: this.state.searchQuery, onChange: _NavbarActions2.default.updateSearchQuery }),
                _react2.default.createElement(
                  'span',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  _reactRouter.Link,
                  { to: '/frontend', className: 'dropdown-toggle', 'data-toggle': 'dropdown' },
                  '前端',
...
var Post = function (_React$Component) {
  ...
  _createClass(Post, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'admin_right col-md-10 col-xs-10 col-sm-10' },
        _react2.default.createElement(
          'form',
          { method: 'post' },
          _react2.default.createElement('div', { id: 'div1', name: 'content' }),
...
},{"../actions/PostActions":4,"../stores/PostStore":18,"react":"react"}],12:[function(require,module,exports){
"use strict";
...
var Sidebar = function (_React$Component) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "admin_left col-md-2 col-sm-2 col-xs-2 " },
        _react2.default.createElement(
          "ul",
          { className: "post" },
          _react2.default.createElement(
...
},{"./components/Navbar":10,"./routes":14,"history/lib/createBrowserHistory":27,"react":"react","react-dom":"react-dom","react-router":"react-router"}],14:[function(require,module,exports){
'use strict';
...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouter.Route, { path: '/game', component: _Home2.default }),
  _react2.default.createElement(_reactRouter.Route, { path: '/anime', component: _Home2.default }),
  _react2.default.createElement(
    _reactRouter.Route,
...
},{"./components/Admin":6,"./components/App":7,"./components/Home":9,"./components/Post":11,"react":"react","react-router":"react-router"}],15:[function(require,module,exports){
'use strict';
...
var HomeStore = function () {
  ...
  _createClass(HomeStore, [{
    ...
    value: function onGetArticleFail(errorMessage) {
